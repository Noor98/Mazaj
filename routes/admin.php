...
Route::resource('special_categories', SpecialCategoryController::class)->middleware('admin');
Route::get('/special_categories/{id}/status', [SpecialCategoryController::class, 'status'])->middleware('admin');
...
Route::get('/customers/{id}/status', [CustomerController::class, 'status'])->middleware('admin');
Route::get('/search/customers', [CustomerController::class, 'Search']);
Route::get('/customers/by_order_type/{id}',[CustomerController::class, 'by_order_type']);
